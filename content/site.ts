...
export const site = {
  ...
  projects: [
    ...
    },
    {
      ...
      repository: "https://github.com/msftnadavbh/copilot-workshop",
      role: "2026 enrichment and maintenance by Nadav; original workshop by Michael Liav",
      summary:
        "A dual-platform, instructor-led workshop for applying GitHub Copilot across VS Code, the CLI, code review, context engineering, and governance.",
      problem:
        "Developer enablement needs more than a feature tour. Teams need exercises, facilitator guidance, answer keys, and a shared way to discuss responsible usage.",
      why: "It packages technical communication as an engineering artifact that another facilitator can run and adapt.",
      technologies: ["GitHub Copilot", "VS Code", "GitHub", "Azure DevOps"],
      metadata: ["~4-hour workshop", "Facilitator kit", "MIT licensed"],
      detail: {
        label: "Learning path",
        steps: ["Context", "Build", "Review", "Govern"],
      },
    },
  ],
  experience: [
