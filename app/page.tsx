  ...
  return (
    <>
      ...
      <main id="main-content">
        ...
        <section
          className="chapter chapter--focus"
          aria-labelledby="focus-heading"
        >
          <div className="section shell focus">
        ...
        <section
          className="chapter chapter--work"
          id="work"
        ...
        >
          <div className="section shell">
            <div className="section-heading section-heading--work">
              ...
              <p>
                Four public projects that show the recurring pattern: make
                complex engineering decisions easier to inspect, use, and
                repeat.
              </p>
            </div>
        ...
        >
          <div className="section shell">
            <div className="section-heading">
              ...
              <p>
                The job titles changed. The useful thread stayed consistent:
                move closer to the decisions that make complicated systems
        ...
        <section
          className="chapter chapter--principles"
          id="principles"
        ...
        <section
          className="chapter chapter--recognition"
        ...
        <section
          className="chapter chapter--beyond"
          aria-labelledby="beyond-heading"
        >
          <div className="section shell beyond">
            <div>
        ...
        <section
          className="chapter chapter--contact contact"
          id="contact"
